...
with col1:
    st.markdown(
        ...
        **三大亮点，助你突破英语学习瓶颈：**
        ...
        拥有智力超群、知识广博的AI教师团队，为你提供纯正的发音和专业的指导。
        利用先进的语音合成技术，打造逼真的互动体验，让你仿佛置身于真实的英语课堂。
        
        2. ⏰ 贴心辅导

        24小时在线虚拟教练，随时随地满足你的学习需求。
        个性化学习计划，根据你的学习水平和目标，定制专属的学习方案。
        及时反馈和纠错，帮助你快速掌握英语知识，避免学习误区。
        
        3. 💰性价比高

        高质量、价格合理的教学服务，让你的每一分钱都用在刀刃上。
        精心设计的课程和优秀的教师团队，确保你获得超值的学习体验。
