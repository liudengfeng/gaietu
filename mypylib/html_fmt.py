...
def view_error_counts_legend(session_state_key: str, idx=None):
    ...
    st.markdown(
        f"<div style='text-align: right; color: black; background-color: #F5F5DC; margin-right: 10px;'>{n1}</div> <span>发音错误</span>",
        help="✨ 说得不正确的字词。",
    ...
    st.markdown(
        f"<div style='text-align: right; color: white; background-color: #A9A9A9; margin-right: 10px;'>{n2}</div> <span>遗漏</span>",
        help="✨ 脚本中已提供，但未说出的字词。",
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        f"<div style='text-align: right; color: white; background-color: #B7410E; margin-right: 10px;'>{n3}</div> <span>插入内容</span>",
    ...
    st.markdown(
        f"<div style='text-align: right; color: black; background-color: #FFC0CB; margin-right: 10px;'>{n4}</div> <span>意外中断</span>",
    ...
    st.markdown(
        f"<div style='text-align: right; color: black; background-color: #D3D3D3; margin-right: 10px;'>{n5}</div> <span>缺少停顿</span>",
    ...
    st.markdown(
        f"<div style='text-align: right; color: white; background-color: #800080; margin-right: 10px;'>{n6}</div> <span>发音单调</span>",
